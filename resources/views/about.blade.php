...
@section('content')
<header class="bg-blue-600 text-white pt-36 pb-20">
    <div class="max-w-6xl mx-auto px-4 text-center">
        <p class="uppercase tracking-[0.4em] text-sm text-blue-200 mb-4">Tentang Kami</p>
        <h1 class="text-4xl md:text-5xl font-bold mb-4">CV. Nirmala Sumber Asri</h1>
        <p class="max-w-3xl mx-auto text-lg text-blue-100">Perusahaan water treatment berpengalaman lebih dari 10 tahun dalam solusi filter air sumur, PAM, demineralisasi, dan depo air minum.</p>
    </div>
</header>
...
<main class="max-w-6xl mx-auto px-4 py-16 flex-grow">
    <section class="grid gap-10 lg:grid-cols-2 items-center">
        ...
        <div class="rounded-3xl overflow-hidden shadow-xl">
            <img src="https://images.unsplash.com/photo-1517836357463-d25dfeac3438?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80" alt="Kantor Nirmala Filter Air" class="w-full h-full object-cover">
        </div>
    </section>

    <section class="mt-16 bg-blue-50 rounded-3xl p-10">
    ...
    <section class="mt-16 bg-white rounded-3xl p-10 shadow-lg">
